 ...
 */
public class MxSensorsTelemetry extends MxSensors

{
     ...
     */
    public MxSensorsTelemetry() {}

    public void updateAutoInitTelemetry(){

        telemetry.addData("1", "Gyro Heading: " + getGyroHeading());
